...
namespace web.Controllers
{
    public class WorkerController : Controller
    {
        ...
        public WorkerController(OcistimeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Worker != null ? 
                          ...
                          Problem("Entity set 'OcistimeContext.Worker'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("WorkerID,LastName,FirstMidName,Mail,Password")] Worker worker)
        {
